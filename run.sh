...
#     --latent_size 96 --i_latent_size 8 --lr 1.05e-05 --phase train --mode train --dataset_path "/home/penghan/HAR-MLDA/STAR/fl_features/sample" --wdir "fl_results/sample/" \
#     --dis_step 4 --batch_size 32 --dataset ntu60 --askg_mode vocab

python train_temporal.py \
    --num_classes 60 --ss 5 --st r --ve shift --le clip-vit-b-32 --tm chat --num_cycles 3 --num_epoch_per_cycle 1500 \
    --latent_size 96 --i_latent_size 8 --lr 2.05e-05 --phase train --mode train --dataset_path "/home/penghan/HAR-MLDA/STAR/fl_features/shift_ntu60_5_r" --wdir "fl_results/shift_ntu60_5_r/" \
    --dis_step 4 --batch_size 32 --dataset ntu60 --askg_mode vocab
