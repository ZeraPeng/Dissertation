...
python train_temporal.py \
    ...
    --latent_size 96 --i_latent_size 8 --lr 1.05e-05 --phase train --mode train --dataset_path "/home/penghan/HAR-MLDA/STAR/fl_features/shift_ntu60_5_r" --wdir "fl_results/shift_ntu60_5_r/" \
