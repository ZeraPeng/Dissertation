...
python train_f.py \
    ...
    --latent_size 96 --i_latent_size 8 --lr 4.9372938499672305e-05 --phase train --mode train --dataset_path "/usr1/home/s124mdg53_04/STAR/packed_features/shift_ntu60_12_r_dict" --wdir "results/shift_ntu60_12_r_dict/" \
    --dis_step 4 --batch_size 32 --dataset ntu60 --alpha $alpha 
