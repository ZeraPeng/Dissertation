...
class ModelMatch(nn.Module):
    def __init__(self,num_class=60, num_point=25, num_person=2, graph=None, graph_args=dict(), in_channels=3,
        ...
        # self.pretraining_model = STGCNModel(in_channels,  num_class, graph_args, edge_importance_weighting, head=['ViT-B/32'], num_point=25, num_person=2, graph=None, **kwargs)
    ...
    def loss_cal(self, part_visual, global_visual, part_language, part_language_seen,part_language_seen_unseen,
        ...
        np.save('/usr1/home/s124mdg53_04/Dissertation/tsen_feature/semantic_space/action_name.npy', all_label_language.detach().cpu().numpy())
        ...
        for i in range(6):
            ...
            np.save('/usr1/home/s124mdg53_04/Dissertation/tsen_feature/semantic_space/part_description_{}.npy'.format(i), tmp.detach().cpu().numpy())
