...
echo "10"
python train_char.py \
    --num_classes 120 --ss 10 --st r --ve shift --le clip-vit-b-32 --tm chat --num_cycles 20 --num_epoch_per_cycle 1700 \
...
echo "24"
python train_char.py \
    --num_classes 120 --ss 24 --st r --ve shift --le clip-vit-b-32 --tm chat --num_cycles 20 --num_epoch_per_cycle 1700 \
    --latent_size 304 --i_latent_size 12 --lr 1.05e-05 --phase train --mode train --dataset_path "/usr1/home/s124mdg53_04/STAR/packed_features/shift_ntu120_24_r_2part" --wdir "char_results/shift_ntu120_24_r/" \
    --dis_step 16 --batch_size 24 --dataset ntu120