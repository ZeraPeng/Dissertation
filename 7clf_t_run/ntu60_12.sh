...
alpha=0.8
body_part=4
dataset_path="/usr1/home/s124mdg53_04/STAR/packed_features/shift_${dataset}_${ss}_r_${body_part}part"
dataset_path="/usr1/home/s124mdg53_04/STAR/packed_features/shift_${dataset}_${ss}_r_${body_part}part"
w_dir="results/shift_${dataset}_${ss}_r_${body_part}part/"

if [ "$dataset" = "ntu60" ]; then
    ls=96 ils=8 lr=3.60E-05 batch_size=32 dis_step=2
    th=0 t=0
...
echo "Running on train_7clf_t.py"
echo "data split: $ss"
# alpha_p=0
# echo "alpha=$alpha, alpha_p=$alpha_p, body_part=$body_part"
# echo "===== $data_split with side info ====="
# python train_7clf_t.py \
#     --num_classes $num_classes --ss "$ss" --st r --ve shift --le clip-vit-b-32 --tm chat --num_cycles 10 --num_epoch_per_cycle 1700 \
